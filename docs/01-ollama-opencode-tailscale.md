...
- **No public exposure**: never `tailscale funnel` (exposes to the public internet), never bind to `0.0.0.0` — only `tailscale serve` (tailnet-private) and binding to a specific Tailscale IP. Re-verify this after any change.
